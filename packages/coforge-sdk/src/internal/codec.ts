...
export function encodeAgentStartIntent(value: AgentStartIntent): Uint8Array {
  ...
  // ADR 0040: the server mints and supplies launchId for every managed (controlEpoch-carrying)
...
export function decodeAgentStartIntent(bytes: Uint8Array): AgentStartIntent {
  ...
  // ADR 0040: a managed start (one carrying controlEpoch) must carry the server-minted
