...
/**
 * Presigned direct-upload sessions (ADR 0027): the Agent PUTs bytes straight to storage with a
 ...
 * where they occur (see the module's own doc comments and ADR 0027).
 */
 ...
 * see ADR 0027's deviation from Raft's `channelId` field to this repo's `#channel`/`@user`
