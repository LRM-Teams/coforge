/**
 * Per-Agent visibility (ADR 0059; CoForge only, no Raft equivalent). `"public"` is visible
 ...
 * new weekly-report Collector Agents (ADR 0032) are the one exception, created `"private"`.
 *
