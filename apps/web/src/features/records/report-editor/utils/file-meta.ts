...
const ARCHIVE_EXTS = new Set<string>(["zip", "rar", "7z", "tar", "gz", "tgz", "bz2", "xz", "zst"]);
 ...
 */
export function getFileTypeCategory(contentType: string, filename: string): FileTypeCategory {
