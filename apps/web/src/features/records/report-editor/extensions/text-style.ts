...
import { sanitizeTextStyle } from "@/features/records/report-editor/utils/text-style";
    ...
    return {
      color: {
        ...
        parseHTML: (element: HTMLElement) =>
          sanitizeTextStyle(element.getAttribute("style") ?? "").color ?? null,
        rendered: false,
      },
      fontSize: {
        default: null,
        parseHTML: (element: HTMLElement) =>
          sanitizeTextStyle(element.getAttribute("style") ?? "").fontSize ?? null,
        rendered: false,
      },
    };
  },
