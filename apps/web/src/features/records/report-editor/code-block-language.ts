...
function normalizeInsertableCodeBlockLanguage(
  value: string | null | undefined,
): InsertableCodeBlockLanguage {
...
export function getLastInsertedCodeBlockLanguage(): InsertableCodeBlockLanguage {
  ...
  return normalizeInsertableCodeBlockLanguage(
    window.localStorage.getItem(LAST_CODE_BLOCK_LANGUAGE_KEY),
  );
}
