...
tanstackIntent:
  - id: "@tanstack/react-start#lifecycle/migrate-from-nextjs"
    run: "bunx intent load @tanstack/react-start#lifecycle/migrate-from-nextjs"
  ...
  - id: "@tanstack/react-start#react-start"
    run: "bunx intent load @tanstack/react-start#react-start"
  ...
  - id: "@tanstack/react-start#react-start/server-components"
    run: "bunx intent load @tanstack/react-start#react-start/server-components"
  ...
  - id: "@tanstack/router-core#router-core"
    run: "bunx intent load @tanstack/router-core#router-core"
  ...
  - id: "@tanstack/router-core#router-core/auth-and-guards"
    run: "bunx intent load @tanstack/router-core#router-core/auth-and-guards"
  ...
  - id: "@tanstack/router-core#router-core/code-splitting"
    run: "bunx intent load @tanstack/router-core#router-core/code-splitting"
  ...
  - id: "@tanstack/router-core#router-core/data-loading"
    run: "bunx intent load @tanstack/router-core#router-core/data-loading"
    for: "Route loader option, loaderDeps for cache keys, staleTime/gcTime/ defaultPreloadStaleTime SWR caching, pendingComponent/pendingMs/ pendingMinMs, errorComponent/onError/onCatch, beforeLoad, router context and createRootRouteWithContext DI pattern, router.invalidate, Await component, deferred data loading with unawaited promises."
  - id: "@tanstack/router-core#router-core/navigation"
    run: "bunx intent load @tanstack/router-core#router-core/navigation"
  ...
  - id: "@tanstack/router-core#router-core/not-found-and-errors"
    run: "bunx intent load @tanstack/router-core#router-core/not-found-and-errors"
  ...
  - id: "@tanstack/router-core#router-core/path-params"
    run: "bunx intent load @tanstack/router-core#router-core/path-params"
  ...
  - id: "@tanstack/router-core#router-core/search-params"
    run: "bunx intent load @tanstack/router-core#router-core/search-params"
  ...
  - id: "@tanstack/router-core#router-core/ssr"
    run: "bunx intent load @tanstack/router-core#router-core/ssr"
  ...
  - id: "@tanstack/router-core#router-core/type-safety"
    run: "bunx intent load @tanstack/router-core#router-core/type-safety"
    for: "Full type inference philosophy (never cast, never annotate inferred values), Register module declaration, from narrowing on hooks and Link, strict:false for shared components, getRouteApi for code-split typed access, addChildren with object syntax for TS perf, LinkProps and ValidateLinkOptions type utilities, as const satisfies pattern."
  - id: "@tanstack/router-plugin#router-plugin"
    run: "bunx intent load @tanstack/router-plugin#router-plugin"
  ...
  - id: "@tanstack/start-client-core#start-core"
    run: "bunx intent load @tanstack/start-client-core#start-core"
  ...
  - id: "@tanstack/start-client-core#start-core/auth-server-primitives"
    run: "bunx intent load @tanstack/start-client-core#start-core/auth-server-primitives"
  ...
  - id: "@tanstack/start-client-core#start-core/deployment"
    run: "bunx intent load @tanstack/start-client-core#start-core/deployment"
  ...
  - id: "@tanstack/start-client-core#start-core/execution-model"
    run: "bunx intent load @tanstack/start-client-core#start-core/execution-model"
  ...
  - id: "@tanstack/start-client-core#start-core/middleware"
    run: "bunx intent load @tanstack/start-client-core#start-core/middleware"
  ...
  - id: "@tanstack/start-client-core#start-core/server-functions"
    run: "bunx intent load @tanstack/start-client-core#start-core/server-functions"
  ...
  - id: "@tanstack/start-client-core#start-core/server-routes"
    run: "bunx intent load @tanstack/start-client-core#start-core/server-routes"
  ...
  - id: "@tanstack/start-server-core#start-server-core"
    run: "bunx intent load @tanstack/start-server-core#start-server-core"
  ...
  - id: "@tanstack/virtual-file-routes#virtual-file-routes"
    run: "bunx intent load @tanstack/virtual-file-routes#virtual-file-routes"
    for: "Programmatic route tree building as an alternative to filesystem conventions: rootRoute, index, route, layout, physical, defineVirtualSubtreeConfig. Use with TanStack Router plugin's virtualRouteConfig option."
  - id: "dotenv#dotenv"
    run: "bunx intent load dotenv#dotenv"
  ...
  - id: "dotenv#dotenvx"
    run: "bunx intent load dotenv#dotenvx"
