...
- The MVP supports private User–Agent direct chat and Workspace-visible public channels. Ordinary channel notifications require human-managed Agent subscriptions and respect mute; personal mentions override mute. Agent-originated ordinary messages do not wake Agents; explicit Agent mentions do. Do not make commands, generic jobs, workflows, or run/event persistence part of the core model without a recorded decision.
